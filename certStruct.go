...
func (c *certClient) Get(name string, opts metav1.GetOptions) (runtime.Object, error) {
...
// func (c *CMCertificate) Create(name string, opts metav1.GetOptions) (runtime.Object, error) {
// 	result := CMCertificate{}
// 	err := c.restClient.
// 		Post().
// 		Namespace("inf").
